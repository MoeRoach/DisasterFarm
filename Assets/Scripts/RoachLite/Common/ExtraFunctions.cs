...
public static class ExtraFunctions {
    ...
    /// <returns>值</returns>
    public static TValue TryGetElement<TKey, TValue>(this Dictionary<TKey, TValue> dict,
        TKey key) {
    ...
    /// <param name="key">键</param>
    /// <returns>值</returns>
    public static TValue TakeAndRemove<TKey, TValue>(this Dictionary<TKey, TValue> dict,
        TKey key) {
        TValue result = default;
