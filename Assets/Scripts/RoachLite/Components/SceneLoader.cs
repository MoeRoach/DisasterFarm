...
// Created By Yu.Liu
namespace RoachLite.MonoComponent {
    /// <summary>
    /// 场景管理器
    /// </summary>
    ...
    public class SceneLoader : MonoSingleton<SceneLoader> {
        ...
        public bool isManulContinue = false;
        #endregion
        ...
        protected Action onMaskShowDone;
        protected Action onMaskHideDone;
        ...
        public void SetupMaskShowDoneCallback(Action callback) {
            onMaskShowDone = callback;
        }
        
        public void SetupMaskHideDoneCallback(Action callback) {
            onMaskHideDone = callback;
        }

        protected override void OnStart() {
            base.OnStart();
            var filter = new BroadcastFilter(CommonConfigs.BROADCAST_FILTER_SCENE_LOAD);
        ...
        protected virtual void ReceiveBroadcast(BroadcastInfo msg) {
